...
SECRET_KEY = '+f6+4ghn_=hza4oqj74w45#lk-x%o_#xi%)f-fgm0e$q5um8*#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['kinbech-django.herokuapp.com', '127.0.0.1']
...
# to confidure a url path to find the images so they can be rendered properly.
# This will set the media root to always start at "images/image_name".
MEDIA_URl = '/images/'
